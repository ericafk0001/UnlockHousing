export default function TermsPage() {
  return (
    <main className="mx-auto flex min-h-[calc(100svh-7rem)] w-full max-w-4xl flex-1 items-start px-4 pb-12 pt-10 sm:px-6 lg:px-8 lg:pt-14">
      <section className="w-full rounded-3xl border border-border bg-card/90 p-6 shadow-md backdrop-blur sm:p-8 lg:p-10">
        ...
        <div className="mt-5 rounded-xl border border-border/70 bg-background/70 px-4 py-3 sm:px-5">
        ...
        <p className="mt-8 rounded-2xl border border-border/70 bg-background/60 p-5 text-[0.95rem] leading-8 text-muted-foreground sm:p-6 sm:text-base">
          Terms and Conditions Last Updated: March 28, 2026 Acceptance of the
          Terms and Conditions These terms of use are entered into by and
          between you and “Unlock Housing” ("we," or "us"). The following terms
          and conditions ("Terms of Use") govern your access to and use of
          unlockhousing.com, including any content, functionality, and services
          offered on or through unlockhousing.com (the "Website") whether as a
          guest or a registered user. Please read the terms and conditions
          carefully. By clicking accept and agree to these terms and conditions,
          you accept and agree to be bound and abide by these terms. By using
          this Website, you represent and warrant that you are at least 18 years
          old in order to form a binding contract with the Company and meet all
          of the foregoing eligibility requirements. If you do not meet all of
          these requirements, you must not access or use the Unlock Housing.
          Changes to the Terms of Use We may revise and update these Terms of
          Use from time to time in our sole discretion. All changes are
          effective immediately when we post them, and apply to all access to
          and use of the Website thereafter.. Your continued use of the Website
          following the posting of revised Terms of Use means that you accept
          and agree to the changes. We are not required to notify you of any
          revisions made. You are expected to check this page frequently so you
          are aware of any changes, as they are binding on you. Accessing the
          Website and Account Security We reserve the right to withdraw or amend
          this Website, and any service or material we provide on the Website,
          in our sole discretion, without notice. We will not be liable if for
          any reason all or any part of the Website is unavailable at any time
          or for any period. From time to time, we may restrict user access,
          including registered user access, to some parts of the Website or the
          entire Website. You are responsible for both: Making all arrangements
          necessary for you to have access to the Website. Ensuring that all
          persons who access the Website through your internet connection are
          aware of these Terms of Use and comply with them. To access the
          ...
          [LINK TO PRIVACY POLICY], and you consent to all actions we take with
          respect to your information consistent with our Privacy Policy. If you
          choose, or are provided with, a username, password, or any other piece
          ...
          other breach of security. You also agree to ensure that you exit your
          ...
          information. We have the right to disable any username, password, or
          ...
          opinion, you have violated any provision of these Terms of Use. User
          Contributions The Website may contain may contain message boards, chat
          ...
          (collectively, "User Contributions") on or through the Website. All
          User Contributions must comply with the Content Standards set out in
          these Terms of Use. Any User Contribution you post to the site will be
          ...
          material. You represent and warrant that: You own or control all
          rights in and to the User Contributions and have the right to grant
          ...
          and assigns. All of your User Contributions do and will comply with
          these Terms of Use. You understand and acknowledge that you are
          responsible for any User Contributions you submit or contribute, and
          you, not the Company, have full responsibility for such content,
          including its legality, reliability, accuracy, and appropriateness. We
          ...
          the Website. Intellectual Property Rights The Website and its entire
          ...
          rights laws. These Terms of Use permit you to use the Website for your
          ...
          on our Website, except as follows: Your computer may temporarily store
          copies of such materials in RAM incidental to your accessing and
          viewing those materials. You may store files that are automatically
          cached by your Web browser for display enhancement purposes. You may
          ...
          license agreement for such applications. You must not: Modify copies
          of any materials from this site. Use any illustrations, photographs,
          video or audio sequences, or any graphics separately from the
          accompanying text. Delete or alter any copyright, trademark, or other
          ...
          Website or any services or materials available through the Website. If
          you wish to make any use of material on the Website other than that
          set out in this section, please address your request to: [EMAIL
          ADDRESS]. If you print, copy, modify, download, or otherwise use or
          provide any other person with access to any part of the Website in
          breach of the Terms of Use, your right to use the Website will stop
          ...
          the Website or any content on the Website is transferred to you, and
          all rights not expressly granted are reserved by the Company. Any use
          of the Website not expressly permitted by these Terms of Use is a
          breach of these Terms of Use and may violate copyright, trademark, and
          other laws. Trademarks The Company name, the terms [COMPANY
          TRADEMARKS], [the Company logo,] and all related names, logos, product
          and service names, designs, and slogans are trademarks of the Company
          or its affiliates or licensors. You must not use such marks without
          the prior written permission of the Company. All other names, logos,
          product and service names, designs, and slogans on this Website are
          the trademarks of their respective owners. Reliance on Information
          Posted The information presented on or through the Website is made
          ...
          provided by other users, third-party licensors, syndicators,
          ...
          accuracy of any materials provided by any third parties. Prohibited
          Uses You may use the Website only for lawful purposes and in
          ...
          these Terms of Use. To transmit, or procure the sending of, any
          ...
          or for any other purpose not expressly authorized in these Terms of
          Use, without our prior written consent. Use any device, software, or
          routine that interferes with the proper working of the Website.
          Introduce any viruses, Trojan horses, worms, logic bombs, or other
          material that is malicious or technologically harmful. Attempt to gain
          ...
          server, computer, or database connected to the Website. Attack the
          Website via a denial-of-service attack or a distributed
          denial-of-service attack. Otherwise attempt to interfere with the
          proper working of the Website. Content Standards These content
          ...
          conflict with these Terms of Use and our Privacy Policy [LINK TO
          ...
          embarrass, alarm, or annoy any other person. Impersonate any person or
          ...
          violate your copyright, please see our Copyright Policy [LINK TO
          COPYRIGHT POLICY] for instructions on sending us a notice of copyright
          infringement. It is the policy of the Company to terminate the user
          accounts of repeat infringers. Changes to the Website We may update
          ...
          to update such material. Information About You and Your Visits to the
          Website All information we collect on this Website is subject to our
          Privacy Policy [LINK TO PRIVACY POLICY]. By using the Website, you
          consent to all actions taken by us with respect to your information in
          compliance with the Privacy Policy. Linking to the Website and Social
          Media Features You may link to our homepage, provided you do so in a
          ...
          without our express written consent. This Website may provide certain
          social media features that enable you to: Link from your own or
          certain third-party websites to certain content on this Website. Send
          emails or other communications with certain content, or links to
          certain content, on this Website. Cause limited portions of content on
          this Website to be displayed or appear to be displayed on your own or
          certain third-party websites. You may use these features solely as
          they are provided by us, and solely with respect to the content they
          are displayed with, and otherwise in accordance with any additional
          terms and conditions we provide with respect to such features. Subject
          to the foregoing, you must not: Establish a link from any website that
          is not owned by you. Cause the Website or portions of it to be
          displayed on, or appear to be displayed by, any other site, for
          example, framing, deep linking, or in-line linking. Link to any part
          of the Website other than the homepage. Otherwise take any action with
          respect to the materials on this Website that is inconsistent with any
          other provision of these Terms of Use. You agree to cooperate with us
          in causing any unauthorized framing or linking immediately to stop. We
          reserve the right to withdraw linking permission without notice. We
          may disable all or any social media features and any links at any time
          without notice in our discretion. Links from the Website If the
          Website contains links to other sites and resources provided by third
          parties, these links are provided for your convenience only. This
          ...
          and conditions of use for such websites. Geographic Restrictions The
          owner of the Website is based in the State of Pennsylvania in the
          ...
          compliance with local laws. Disclaimer of Warranties You understand
          that we cannot and do not guarantee or warrant that files available
          ...
          THE WEBSITE OR YOUR DOWNLOADING OF ANY MATERIAL POSTED ON IT, OR ON
          ...
          UNDER APPLICABLE LAW. Limitation on Liability TO THE FULLEST EXTENT
          ...
          OTHERWISE, EVEN IF FORESEEABLE. The limitation of liability set out
          above does not apply to liability resulting from our gross negligence
          or willful misconduct. THE FOREGOING DOES NOT AFFECT ANY LIABILITY
          THAT CANNOT BE EXCLUDED OR LIMITED UNDER APPLICABLE LAW. Waiver and
          Severability No waiver by the Company of any term or condition set out
          in these Terms of Use shall be deemed a further or continuing waiver
          ...
          of the State of Pennsylvania, in each case located in the City of
          Philadelphia. You waive any and all objections to the exercise of
          jurisdiction over you by such courts and to venue in such courts.
          Arbitration At Company's sole discretion, it may require you to submit
          any disputes arising from these Terms of Use or use of the Website,
          ...
          Arbitration Association applying Pennsylvania law. Limitation on Time
          to File Claims ANY CAUSE OF ACTION OR CLAIM YOU MAY HAVE ARISING OUT
          OF OR RELATING TO THESE TERMS OF USE OR THE WEBSITE MUST BE COMMENCED
          WITHIN ONE (1) YEAR AFTER THE CAUSE OF ACTION ACCRUES; OTHERWISE, SUCH
          CAUSE OF ACTION OR CLAIM IS PERMANENTLY BARRED. Monitoring and
          Enforcement; Termination We have the right to: Remove or refuse to
          post any User Contributions for any or no reason at our sole
          discretion. Take any action with respect to any User Contribution that
          we deem necessary or appropriate in our sole discretion, including if
          ...
          liability for the Company. Disclose your identity or other information
          ...
          their right to privacy. Take appropriate legal action, including
          without limitation, referral to law enforcement, for any illegal or
          unauthorized use of the Website. Terminate or suspend your access to
          all or part of the Website for any or no reason, including without
          limitation, any violation of these Terms of Use. Without limiting the
          ...
          BY EITHER THE COMPANY OR LAW ENFORCEMENT AUTHORITIES. However, we
          cannot/do not undertake to review all material before it is posted on
          ...
          activities described in this section. Entire Agreement The Terms and
          Conditions, our Privacy Policy,[and LIST OTHER RELEVANT DOCUMENTS OR
          POLICIES] constitute the sole and entire agreement between you and
          “Unlock Housing” regarding the Website Your Comments and Concerns This
          website is operated by “Unlock Housing” [COMPANY ADDRESS]. All other
